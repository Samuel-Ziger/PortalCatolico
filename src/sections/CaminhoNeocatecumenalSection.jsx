      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-white dark:bg-dark-card rounded-2xl shadow-xl p-8 md:p-12">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 dark:text-dark-text mb-4">O Caminho Neocatecumenal</h1>
            <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300">Um itinerário de formação católica pós-batismal</p>
          </div>

          <div className="space-y-12">
            <section className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 p-6 md:p-8 rounded-xl shadow-md">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 pt-1">
                  <Users className="h-10 w-10 text-blue-600" />
                </div>
                <div>
                  <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-dark-text mb-3">O Que é?</h2>
            ...
            <section className="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 p-6 md:p-8 rounded-xl shadow-md">
              <div className="flex items-start space-x-4">
                <div className="flex-shrink-0 pt-1">
                  <BookOpen className="h-10 w-10 text-purple-600" />
                </div>
                <div>
                  <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-dark-text mb-3">Origem e Propósito</h2>
                  <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-base md:text-lg">
            ...
            <section className="bg-gradient-to-r from-pink-50 to-red-50 dark:from-gray-700 dark:to-gray-600 p-6 md:p-8 rounded-xl shadow-md">
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-dark-text mb-6 text-center">Os Iniciadores</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                  <div className="flex items-center space-x-3 mb-3">
                    <UserCircle className="h-8 w-8 text-red-500" />
                    <h3 className="text-xl font-medium text-gray-800 dark:text-dark-text">Kiko Argüello</h3>
                  </div>
                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                  <div className="flex items-center space-x-3 mb-3">
                    <UserCircle className="h-8 w-8 text-red-500" />
                    <h3 className="text-xl font-medium text-gray-800 dark:text-dark-text">Carmen Hernández</h3>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed">
            ...
            <section className="bg-gradient-to-r from-purple-50 to-pink-50 dark:from-gray-700 dark:to-gray-600 p-6 md:p-8 rounded-xl shadow-md">
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-dark-text mb-6 text-center">Pilares do Caminho</h2>
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                  <Award className="h-10 w-10 text-blue-500 mx-auto mb-2" />
                  <h3 className="text-xl font-medium text-gray-800 dark:text-dark-text mb-1">Palavra</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">Escuta e meditação da Palavra de Deus, especialmente nas celebrações semanais.</p>
                </div>
                <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                  <Award className="h-10 w-10 text-purple-500 mx-auto mb-2" />
                  <h3 className="text-xl font-medium text-gray-800 dark:text-dark-text mb-1">Liturgia</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">Participação ativa na Eucaristia dominical e outras celebrações litúrgicas renovadas.</p>
                </div>
                <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-lg transition-shadow">
                  <Award className="h-10 w-10 text-pink-500 mx-auto mb-2" />
                  <h3 className="text-xl font-medium text-gray-800 dark:text-dark-text mb-1">Comunidade</h3>
                  <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base">Vida fraterna em pequena comunidade, onde se experimenta o amor e o perdão.</p>
                </div>
              </div>
            </section>

            <section className="bg-gradient-to-r from-green-50 to-teal-50 dark:from-gray-700 dark:to-gray-600 p-6 md:p-8 rounded-xl shadow-md">
              <h2 className="text-2xl md:text-3xl font-semibold text-gray-800 dark:text-dark-text mb-8 text-center">Linha do Tempo</h2>
              <div className="relative">
                <div className="hidden md:block absolute top-0 bottom-0 left-1/2 w-1 bg-teal-300 dark:bg-teal-600 transform -translate-x-1/2"></div>
                {timelineEvents.map((item, index) => (
                  <div key={index} className={`mb-8 flex md:items-center w-full ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                    <div className="hidden md:block w-1/2"></div>
                    <div className="hidden md:block relative">
                      <div className="absolute w-5 h-5 bg-teal-500 rounded-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 border-4 border-white dark:border-gray-800 shadow-md"></div>
                    </div>
                    <div className="w-full md:w-1/2 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md md:ml-4 md:mr-4">
                      <div className="flex items-center mb-2">
                        <CalendarDays className="h-6 w-6 text-teal-600 dark:text-teal-400 mr-2" />
                        <h3 className="text-lg font-semibold text-teal-700 dark:text-teal-400">{item.year}</h3>
                      </div>
                      <p className="text-gray-700 dark:text-gray-300 text-sm md:text-base leading-relaxed">{item.event}</p>
                    </div>
                  </div>
                ))}
              </div>
